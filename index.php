...
<div class="body__overlay"></div>
        ...
        <!-- Start Slider Area -->
        <div class="slider__container slider--one bg__cat--3 " style="width: 100%; height: 100vh; background:bg.jpg top right no-repeat; background-size:cover; position: relative;">
                        ...
                        <div class="row align-items__center">
                            ...
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="<?php echo BANNER_IMAGE_SITE_PATH.$rowBanner['image']?>" alt="slider images">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product.php?id=<?php echo $list['id']?>">
                                            <img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image']?>" alt="product images" style="height:300px; wridth:300px;">
                                        </a>
                                    </div>
                    ...
                    <div class="product__list clearfix mt--30">
                            ...
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="product.php?id=<?php echo $list['id']?>">
                                            <img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image']?>" alt="product images" style="height:300px; wridth:400px;">
                                        </a>
                                    </div>
                                    <div class="fr__hover__info">
										<ul class="product__action">
