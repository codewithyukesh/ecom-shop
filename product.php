                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-7 col-lg-7 col-sm-12 col-xs-12 smt-40 xmt-40">
                            <div class="ht__product__dtl product-thumbnail" >
                                <h2><?php echo $get_product['0']['name']?></h2>
                                <ul  class="pro__prize">
                                    <li class="old__prize">Rs. <?php echo $get_product['0']['mrp']?></li>
                                    <li>Rs. <?php echo $get_product['0']['price']?></li>
                                </ul>
                                <p class="pro__info"> Short Description:  <?php echo $get_product['0']['short_desc']?></p>
                                <div class="ht__pro__desc">
									...
									<div class="sin__desc">
                                    <p> <span>Size: </span> <?php echo $get_product['0']['size']?></p>
										</p>
                                    </div>
