                        ...
                        <div class="col-xs-12">
                            <div class="bradcaump__inner">
                                <nav class="bradcaump-inner">
                                  ...
                                  <span class="breadcrumb-item active">Oder Detail</span>
                                </nav>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="wishlist-table table-responsive">
                                    <table>
                                        ...
                                        <tbody>
											...
											<tr>
												<td colspan="4"></td>
												<td class="product-name">Used Point Value</td>
												<td class="product-name"><?php echo $pointValue?></td>
											...
											<tr>
												...
												<?php 
												echo $total_price-$coupon_value-$pointValue;
												?></td>
