...
if(isset($_GET['type']) && $_GET['type']!=''){
	...
	if($type=='status'){
		...
		$update_status_sql="update coupons set status='$status' where id='$id'";
		  ...
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   ...
				   <a href="manage_coupon_master.php"><input type="button" value="Add Coupon" style="background-color:#2275b5; color:white;border-radius: 5px;  border-color :#2275b5;" ></a>
