		  ...
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   ...
				   <a href="manage_sub_categories.php"><input type="button" value="Add Sub Categories" style="background-color:#2275b5; color:white;border-radius: 5px;  border-color :#2275b5;" ></a>
