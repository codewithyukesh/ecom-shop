		  ...
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   ...
				   <a href="manage_banner.php"><input type="button" value="Add Banner" style="background-color:#2275b5; color:white;border-radius: 5px;  border-color :#2275b5;" ></a>
					  ...
					  <table class="table ">
						 ...
						 <tbody>
							...
							<tr>
							   ...
							   <td><img src="<?php echo BANNER_IMAGE_SITE_PATH.$row['image']?>"/></td>
