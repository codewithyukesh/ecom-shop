							...
							<div class="card-body card-block">
							   <div class="form-group">
								...
								<div class="form-group">
									...
									<?php
										if($image!=''){
echo "<a target='_blank' href='".BANNER_IMAGE_SERVER_PATH.$image."'><img width='150px' src='".BANNER_IMAGE_SERVER_PATH.$image."'/></a>";
										}
										?>
								</div>
								<div class="form-group">
							   ...
							   <button id="submit_button" name="submit" type="submit" class="btn btn-lg btn-info btn-block">
							   <span id="banners-button-amount">Submit</span>
							   </button>
